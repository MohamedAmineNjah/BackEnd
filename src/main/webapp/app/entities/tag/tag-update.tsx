  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="crudDbApp.tag.home.createOrEditLabel">
            <Translate contentKey="crudDbApp.tag.home.createOrEditLabel">Create or edit a Tag</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : tagEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="nameLabel" for="tag-name">
                  <Translate contentKey="crudDbApp.tag.name">Name</Translate>
                </Label>
                <AvField
                  id="tag-name"
                  type="text"
