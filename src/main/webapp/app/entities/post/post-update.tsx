  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="crudDbApp.post.home.createOrEditLabel">
            <Translate contentKey="crudDbApp.post.home.createOrEditLabel">Create or edit a Post</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : postEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="titleLabel" for="post-title">
                  <Translate contentKey="crudDbApp.post.title">Title</Translate>
                </Label>
                <AvField
                  id="post-title"
                  type="text"
              ...
              <AvGroup>
                <Label id="contentLabel" for="post-content">
                  <Translate contentKey="crudDbApp.post.content">Content</Translate>
                </Label>
                <AvInput
                  id="post-content"
                  type="textarea"
              ...
              <AvGroup>
                <Label id="dateLabel" for="post-date">
                  <Translate contentKey="crudDbApp.post.date">Date</Translate>
                </Label>
                <AvInput
                  id="post-date"
                  type="datetime-local"
              ...
              <AvGroup>
                <Label for="post-blog">
                  <Translate contentKey="crudDbApp.post.blog">Blog</Translate>
                </Label>
              ...
              <AvGroup>
                <Label for="post-tag">
                  <Translate contentKey="crudDbApp.post.tag">Tag</Translate>
                </Label>
                <AvInput
                  id="post-tag"
                  type="select"
